...
export async function generateMetadata({ params }) {
    ...
    return {
        ...
        description: `Aqui na Perfume de Flor personalizados você encontra o melhor em ${tituloCategoria} personalizados(as) do jeitinho que você gosta !`,
        alternates: {
            canonical: `${urlSite1}produtos/${tituloCategoria}/${tituloCategoria + tituloId}`
        },
        keywords: `${tituloNome}, ${tituloCategoria}, ${tituloId}, perfume, de, flor, personalizados, brasil`
    }
}
